...
class OrderShippingAddressApi {
    ...
    getOrderShippingAddresses(orderId, page, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.apiClient.get(`/v2/orders/${orderId}/shipping_addresses`, page, limit || common_1.Limit.DEFAULT);
    ...
    updateOrderShippingAddress(orderId, orderShippingAddressId, orderShippingAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.apiClient.put(`/v2/orders/${orderId}/shipping_addresses/${orderShippingAddressId}`, orderShippingAddress);
            return response.data;
        });
    }
}
