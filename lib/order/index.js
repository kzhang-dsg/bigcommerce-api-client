...
const order_consignments_api_1 = require("./order-consignments-api");
...
class OrderApi {
    constructor(apiClient) {
        ...
        this.orderConsignments = new order_consignments_api_1.OrderConsignmentApi(this.apiClient);
    ...
    getAllOrders(params, page, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.apiClient.get((0, util_1.appendQueryString)("/v2/orders", params), page, limit || common_1.Limit.DEFAULT);
