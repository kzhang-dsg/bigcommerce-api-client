...
class SearchFilterSettingsApi {
    ...
    getEnabledFilters(page, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.apiClient.get("/v3/settings/search/filters", page, limit || common_1.Limit.DEFAULT);
    ...
    getAvailableFilters(params, page, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.apiClient.get((0, util_1.appendQueryString)("/v3/settings/search/filters/available", params), page, limit || common_1.Limit.DEFAULT);
            return response.data;
        });
    }
    getContextualFilters(params, page, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.apiClient.get((0, util_1.appendQueryString)("/v3/settings/search/filters/contexts", params), page, limit || common_1.Limit.DEFAULT);
            return response.data;
        });
    }
