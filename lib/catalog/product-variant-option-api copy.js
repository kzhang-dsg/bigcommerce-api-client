...
class ProductVariantOptionValueApi {
    ...
    getVariantOptionValue(productId, optionId, valueId, params) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.apiClient.get((0, util_1.appendQueryString)(`/v3/catalog/products/${productId}/option/${optionId}/values/${valueId}`, params));
            return response.data;
        });
    }
    updateVariantOptionValue(productId, optionId, optionValueId, optionValue) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.apiClient.put(`/v3/catalog/products/${productId}/option/${optionId}/values/${optionValueId}`, optionValue);
            return response.data;
        });
    }
    deleteVariantOptionValue(productId, optionId, valueId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.apiClient.delete(`/v3/catalog/products/${productId}/option/${optionId}/values/${valueId}`);
        });
    }
}
