...
class ProductCustomFieldApi {
    ...
    getAllCustomFields(productId, params, page, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.apiClient.get((0, util_1.appendQueryString)(`/v3/catalog/products/${productId}/custom-fields`, params), page, limit);
    ...
    updateCustomField(productId, customField) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.apiClient.put(`/v3/catalog/products/${productId}/custom-fields/${customField.id}`, customField);
            return response.data;
        });
    }
...
//# sourceMappingURL=product-custom-field-api.js.map