...
const product_variant_option_api_copy_1 = require("./product-variant-option-api copy");
...
class CatalogApi {
    constructor(apiClient) {
        ...
        this.productVariantOptionValues = new product_variant_option_api_copy_1.ProductVariantOptionValueApi(this.apiClient);
