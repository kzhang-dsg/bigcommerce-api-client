...
class ProductVideoApi {
    ...
    getAllVideos(productId, params, page, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.apiClient.get((0, util_1.appendQueryString)(`/v3/catalog/products/${productId}/videos`, params), page, limit);
    ...
    updateVideo(productId, video) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.apiClient.put(`/v3/catalog/products/${productId}/videos/${video.id}`, video);
            return response.data;
        });
    }
