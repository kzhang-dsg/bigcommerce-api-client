...
class ProductBuckPricingRuleApi {
    ...
    getAllBuckPricingRules(productId, params, page, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.apiClient.get((0, util_1.appendQueryString)(`/v3/catalog/products/${productId}/bulk-pricing-rules`, params), page, limit);
    ...
    updateBuckPricingRule(productId, buckPricingRule) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.apiClient.put(`/v3/catalog/products/${productId}/bulk-pricing-rules/${buckPricingRule.id}`, buckPricingRule);
            return response.data;
        });
    }
...
//# sourceMappingURL=product-buck-pricing-rule-api.js.map