...
class ProductModifierValueApi {
    ...
    updateModifierValue(productId, modifierId, modifierValue) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.apiClient.put(`/v3/catalog/products/${productId}/modifiers/${modifierId}/values/${modifierValue.id}`, modifierValue);
            return response.data;
        });
    }
