...
class ProductComplexRuleApi {
    ...
    getAllComplexRules(productId, params, page, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.apiClient.get((0, util_1.appendQueryString)(`/v3/catalog/products/${productId}/complex-rules`, params), page, limit);
    ...
    updateComplexRule(productId, complexRule) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.apiClient.put(`/v3/catalog/products/${productId}/complex-rules/${complexRule.id}`, complexRule);
            return response.data;
        });
    }
...
//# sourceMappingURL=product-complex-rule-api.js.map