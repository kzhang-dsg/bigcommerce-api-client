...
class CategoryApi {
    ...
    getAllCategories(params, page, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.apiClient.get((0, util_1.appendQueryString)("/v3/catalog/categories", params), page, limit || common_1.Limit.DEFAULT);
    ...
    getCategory(categoryId, params) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.apiClient.get((0, util_1.appendQueryString)(`/v3/catalog/categories/${categoryId}`, params), undefined);
            return response.data;
        });
    }
