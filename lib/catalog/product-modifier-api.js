...
class ProductModifierApi {
    ...
    getAllModifiers(productId, params, page, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.apiClient.get((0, util_1.appendQueryString)(`/v3/catalog/products/${productId}/modifiers`, params), page, limit || common_1.Limit.DEFAULT);
    ...
    updateModifier(productId, modifierId, modifier) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.apiClient.put(`/v3/catalog/products/${productId}/modifiers/${modifierId}`, modifier);
            return response.data;
        });
    }
