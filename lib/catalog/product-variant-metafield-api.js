...
class ProductVariantMetafieldApi {
    ...
    getAllMetafields(productId, variantId, params, page, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.apiClient.get((0, util_1.appendQueryString)(`/v3/catalog/products/${productId}/variants/${variantId}/metafields`, params), page, limit);
    ...
    updateMetafield(productId, variantId, metafield) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.apiClient.put(`/v3/catalog/products/${productId}/variants/${variantId}/metafields/${metafield.id}`, metafield);
            return response.data;
        });
    }
