...
class ProductChannelAssignmentApi {
    ...
    getAllChannelAssignments(params, page, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.apiClient.get((0, util_1.appendQueryString)(`/v3/catalog/products/channel-assignments`, params), page, limit || common_1.Limit.DEFAULT);
            return response.data;
        });
    }
    createChannelAssignments(channelAssignments) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.apiClient.put(`/v3/catalog/products/channel-assignments`, channelAssignments);
        });
    }
