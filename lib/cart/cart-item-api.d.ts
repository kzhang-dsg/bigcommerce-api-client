...
export declare class CartLineItemApi {
    ...
    updateCartLineItem<Params extends IncludeQueryParams, T extends Cart_Line_Item_Update_Put, R extends Cart_Full>(cartId: string, cartLineItemId: number, cartLineItems: T, params?: Params): Promise<R>;
    deleteCartLineItem<Params extends IncludeQueryParams, R extends Cart_Full>(cartId: string, cartLineItemId: number, params?: Params): Promise<R>;
}
