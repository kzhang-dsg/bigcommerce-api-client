...
export declare class CustomersV2Api {
    ...
    createCustomer<T extends customer_Post, R extends customer_Full>(customer: T): Promise<R>;
    deleteCustomers(): Promise<void>;
    getCustomer<T extends customer_Full>(customerId: number): Promise<T>;
    updateCustomer<T extends customer_Put, R extends customer_Full>(customerId: number, customer: T): Promise<R>;
