...
class CustomerGroupApi {
    ...
    getAllCustomerGroups(params, page, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.apiClient.get((0, util_1.appendQueryString)("/v2/customer_groups", params), page, limit);
    ...
    updateCustomerGroup(customerGroup) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.apiClient.put(`/v2/customer_groups/${customerGroup.id}`, customerGroup);
            return response.data;
        });
    }
