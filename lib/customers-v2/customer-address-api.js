...
class CustomerAddressApi {
    ...
    getAllCustomerAddresses(customerId, page, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.apiClient.get(`/v2/customers/${customerId}/addresses`, page, limit || common_1.Limit.DEFAULT);
    ...
    updateCustomerAddress(customerId, customerAddressId, customerAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.apiClient.put(`/v2/customers/${customerId}/addresses/${customerAddressId}`, customerAddress);
            return response.data;
        });
    }
