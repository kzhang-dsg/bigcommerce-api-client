...
class ApiClient {
    constructor(config) {
        ...
        this.axiosInstance.defaults.transformResponse = [util_1.dateTransformer];
        if ((_a = this.config.cache) === null || _a === void 0 ? void 0 : _a.enable) {
            let storage;
            if (((_b = this.config.cache) === null || _b === void 0 ? void 0 : _b.type) === common_1.CacheType.REDIS) {
                storage = (0, region_aware_redis_1.buildRegionAwareRedisStorage)((_c = this.config.cache) === null || _c === void 0 ? void 0 : _c.redisClientOptions);
            }
            else {
    ...
    get(url, page, limit, config) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (limit === common_1.Limit.ALL || (limit || 0) > common_1.Limit.MAX_LIMIT) {
                ...
                if (totalPages) {
                    ...
                    while (page < totalPages) {
                        const remainingLimit = (limit || 0) - page * common_1.Limit.MAX_LIMIT;
                        page++;
                        response = yield this.callWithRetries("get", (0, util_1.appendQueryString)(url, {
                            page: page,
                            limit: limit === common_1.Limit.ALL
    ...
    delete(url, config) {
        return __awaiter(this, void 0, void 0, function* () {
            config = this.setupCacheInvalidationConfig(url, config);
            return yield this.callWithRetries("delete", url, null, config);
        });
    }
