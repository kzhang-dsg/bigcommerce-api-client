...
class ApiClient {
    constructor(config) {
        ...
        if (((_a = this.config.cache) === null || _a === void 0 ? void 0 : _a.type) === common_1.CacheType.REDIS) {
            storage = (0, region_aware_redis_1.buildRegionAwareRedisStorage)(((_b = this.config.cache) === null || _b === void 0 ? void 0 : _b.cacheKeyPrefix) || "axios", (_c = this.config.cache) === null || _c === void 0 ? void 0 : _c.redisClientOptions);
        }
        else {
    ...
    get(url, page, limit, config) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const maxLimit = url.startsWith("/v3/catalog/products?") &&
                url.indexOf("include=") > -1
                ? common_1.Limit.PRODUCTS_V3_MAX_LIMIT
                : common_1.Limit.MAX_LIMIT;
            if (limit === common_1.Limit.ALL || (limit || 0) > maxLimit) {
                ...
                if (totalPages) {
                    ...
                    while (page < totalPages) {
                        const perPage = ((_f = (_e = (_d = response.data) === null || _d === void 0 ? void 0 : _d.meta) === null || _e === void 0 ? void 0 : _e.pagination) === null || _f === void 0 ? void 0 : _f.per_page) || maxLimit;
                        ...
                        if (result.data && ((_g = response.data) === null || _g === void 0 ? void 0 : _g.data)) {
                    ...
                    while (true) {
                        ...
                        if ((_h = response.data) === null || _h === void 0 ? void 0 : _h.length) {
                ...
                try {
                    ...
                    if (!this.config.failOn404 &&
                        ...
                        if (((_d = error.response) === null || _d === void 0 ? void 0 : _d.status) === 429) {
                            retryDelay = parseInt(((_e = error.response) === null || _e === void 0 ? void 0 : _e.headers["X-Rate-Limit-Time-Reset-Ms"]) || retryDelay, 10);
                        }
                        retries++;
                        ...
                        const response = error.response;
                        if (request && response) {
                            throw new Error(`Failed to call BigCommerce API ${request.protocol}://${request.host}${request.path}. Response Status: ${response.status}, Response: ${JSON.stringify(response.data, null, 0)}.`, { cause: error });
                        }
                        if (request) {
                            if (error.code === "ECONNABORTED") {
                                throw new Error(`Failed to call BigCommerce API ${request.protocol}://${request.host}${request.path}. Timeout after ${this.config.timeout} ms.`, { cause: error });
                            }
                            throw new Error(`Failed to call BigCommerce API ${request.protocol}://${request.host}${request.path}.`, { cause: error });
                        }
