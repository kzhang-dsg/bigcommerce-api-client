...
exports.OrderTransactionApi = void 0;
...
class OrderTransactionApi {
    ...
    getTransactions(orderId, page, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.apiClient.get(`/v3/orders/${orderId}/transactions`, page, limit);
            return response.data;
        });
    }
}
exports.OrderTransactionApi = OrderTransactionApi;
