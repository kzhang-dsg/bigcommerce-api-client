...
class PaymentActionApi {
    ...
    getRefundsForOrder(orderId, page, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.apiClient.get(`/v3/orders/${orderId}/payment_actions/refunds`, page, limit || common_1.Limit.DEFAULT);
            return response.data;
        });
    }
    ...
    getAllRefunds(params, page, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.apiClient.get((0, util_1.appendQueryString)(`/v3/orders/payment_actions/refunds`, params), page, limit || common_1.Limit.DEFAULT);
            return response.data;
        });
    }
