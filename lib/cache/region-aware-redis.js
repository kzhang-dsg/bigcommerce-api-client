...
function buildRegionAwareRedisStorage(redisClientOptions) {
    ...
    const storage = (0, axios_cache_interceptor_1.buildStorage)({
        find(key) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const result = yield client.get(`axios-cache:${key}`);
        ...
        set(key, value) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                yield client.set(`axios-cache:${key}`, JSON.stringify(value), {
        ...
        remove(key) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (key.endsWith("*")) {
                    const keys = yield client.keys(`axios-cache:${key}`);
                    for (const k of keys) {
                        client.del(k);
                    }
                }
                else {
                    yield client.del(`axios-cache:${key}`);
                }
            });
        },
    });
