...
exports.DateFormat = exports.CacheType = exports.Sort = exports.Limit = exports.OrderStatus = void 0;
var OrderStatus;
...
(function (Limit) {
    ...
    Limit[Limit["DEFAULT"] = 0] = "DEFAULT";
    Limit[Limit["MAX_LIMIT"] = 250] = "MAX_LIMIT";
    Limit[Limit["BATCH_MAX_LIMIT"] = 10] = "BATCH_MAX_LIMIT";
...
(function (DateFormat) {
    ...
    DateFormat[DateFormat["UNIX_TIMESTAMP"] = 1] = "UNIX_TIMESTAMP";
