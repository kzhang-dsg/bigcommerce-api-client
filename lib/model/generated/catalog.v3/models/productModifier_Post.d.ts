...
export type productModifier_Post = ({
    ...
    config?: {
         ...
         *
         */
        date_limit_mode?: productModifier_Post.date_limit_mode;
        /**
         ...
         *
         */
        file_types_mode?: productModifier_Post.file_types_mode;
        /**
         ...
         *
         */
        number_limit_mode?: productModifier_Post.number_limit_mode;
        /**
         ...
         *
         */
        product_list_shipping_calc?: productModifier_Post.product_list_shipping_calc;
    };
    option_values?: Array<(({
        /**
...
export declare namespace productModifier_Post {
    /**
     * BigCommerce API, which determines how it will display on the storefront. Acceptable values: `date`, `checkbox`, `file`, `text`, `multi_line_text`, `numbers_only_text`, `radio_buttons`, `rectangles`, `dropdown`, `product_list`, `product_list_with_images`, `swatch`. Required in a /POST.
     *
     */
