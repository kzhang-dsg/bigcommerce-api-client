 ...
 */
export type productModifierOptionValue_Post = ({
    /**
    ...
    adjusters?: {
        ...
        price?: {
             ...
             *
             */
            adjuster?: productModifierOptionValue_Post.adjuster | null;
            /**
...
export declare namespace productModifierOptionValue_Post {
    /**
     * The type of adjuster for either the price or the weight of the variant, when the modifier value is selected on the storefront.
     *
     */
