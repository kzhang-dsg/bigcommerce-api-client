...
export type productOptionConfig_Full = {
     ...
     *
     */
    date_limit_mode?: productOptionConfig_Full.date_limit_mode;
    /**
     ...
     *
     */
    file_types_mode?: productOptionConfig_Full.file_types_mode;
    /**
     ...
     *
     */
    number_limit_mode?: productOptionConfig_Full.number_limit_mode;
    /**
     ...
     *
     */
    product_list_shipping_calc?: productOptionConfig_Full.product_list_shipping_calc;
};
export declare namespace productOptionConfig_Full {
    /**
     * (date) The type of limit that is allowed to be entered on a date option.
     *
     */
