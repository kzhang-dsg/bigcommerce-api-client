...
class PriceListRecordApi {
    ...
    getAllPriceListRecords(priceListId, params, page, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.apiClient.get((0, util_1.appendQueryString)(`/v3/pricelists/${priceListId}/records`, params), page, limit || common_1.Limit.DEFAULT);
    ...
    getPriceListRecordByVariant(priceListId, variantId, page, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.apiClient.get(`/v3/pricelists/${priceListId}/records/${variantId}`, page, limit || common_1.Limit.DEFAULT);
            return response.data;
        });
    }
    getPriceListRecordByCurrencyCode(priceListId, variantId, currencyCode, page, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.apiClient.get(`/v3/pricelists/${priceListId}/records/${variantId}/${currencyCode}`, page, limit || common_1.Limit.DEFAULT);
            return response.data;
        });
    }
