...
class ThemeConfigurationApi {
    ...
    getThemeConfiguration(themeUuid, params, page, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.apiClient.get((0, util_1.appendQueryString)(`/v3/themes/${themeUuid}/actions/configurations`, params), page, limit || common_1.Limit.DEFAULT);
