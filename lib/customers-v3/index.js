...
const customer_atribute_api_1 = require("./customer-atribute-api");
const customer_atribute_value_api_1 = require("./customer-atribute-value-api");
const MAX_BATCH_SIZE = 10;
class CustomersV3Api {
    constructor(apiClient) {
        this.apiClient = apiClient;
        this.customerAddresses = new customer_address_api_1.CustomerAddressApi(this.apiClient);
        this.customerAttributeValues = new customer_atribute_value_api_1.CustomerAttributeValueApi(this.apiClient);
        this.customerAttributes = new customer_atribute_api_1.CustomerAttributeApi(this.apiClient);
    }
