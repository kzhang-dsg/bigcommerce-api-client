...
const customer_stored_instrument_api_1 = require("./customer-stored-instrument-api");
const customer_valid_credential_api_1 = require("./customer-valid-credential-api");
...
class CustomersV3Api {
    constructor(apiClient) {
        ...
        this.customerStoredInstruments = new customer_stored_instrument_api_1.CustomerStoredInstrumentApi(this.apiClient);
        this.validateCustomerCredentials = new customer_valid_credential_api_1.ValidateCustomerCredentialApi(this.apiClient);
    }
    getAllCustomers(params, page, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.apiClient.get((0, util_1.appendQueryString)("/v3/customers", params), page, limit || common_1.Limit.DEFAULT);
